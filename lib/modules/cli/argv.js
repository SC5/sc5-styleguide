...
module.exports = function(argLib) {
  return argLib
    ...
    .describe('enablePug', 'This bool use to enable Pug (Jade) support, false by default')
    .describe('title', 'This string is used as a page title and in the page header')
    .describe('favIcon', 'This enables to replace the default SC5 favicon. It takes path as a string.')
    ...
    .describe('includeDefaultStyles', 'Enables to Include/exclude default styles');
};
