    ...
    kss.parse(block.kss, options, function(err, styleguide) {
      ...
      if (err) {
        ...
        if (section.length > 0) {
          ...
          section[0] = _.assign(section[0], kssAdditionalParams.get(block.kss));
...
function processFile(contents, syntax, options) {
  return Q.Promise(function(resolve, reject) {
    var blockPromises = [],
        blocks;
    try {
  ...
  parseKssSections: function(files, options) {
    return Q.Promise(function(resolve, reject) {
      ...
      Object.keys(files).forEach(function(filePath) {
        ...
        filePromises.push(processFile(contents, syntax, options));
      });
