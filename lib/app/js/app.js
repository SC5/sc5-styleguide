...
if( _styleguideConfig.additionalNgDependencies &&
  _styleguideConfig.additionalNgDependencies.length &&
  _styleguideConfig.additionalNgDependencies.length > 0 ){
  deps = deps.concat( _styleguideConfig.additionalNgDependencies );
