...
angular.module('sgApp')
  .controller('MainCtrl', function($scope, $location, $state, Styleguide, Variables, localStorageService, Socket, $filter, $window) {
    ...
    $scope.$on('$viewContentLoaded', function() {
      var list = angular.element(document.querySelector(".sg-nav-section")).find('ul');
